...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "jogl-rcp-demo.core";
    ...
    // Eclipse loads first. If you don't put this early enough, you'll probably
    // get SIGSEGV in libpthread.so (or other sorts of multithreading errors) when you
